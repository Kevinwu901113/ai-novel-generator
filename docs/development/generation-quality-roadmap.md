...
| Active PR                  | #26（`docs/writing-first-product-reset`，OPEN，ready for review，未合并）                                                                                                                                                  |
...
> **PR #25 decision**: PR #25（`feat/manuscript-renderer-mv1b`）remains OPEN and Draft and will not be merged as product-complete. It will be split and superseded: its infrastructure and Renderer assets will be selectively reused through replacement PRs（Manuscript Transport Foundation + Writer-first Workspace）。
